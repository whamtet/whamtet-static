...
var seq__1412_1416 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1413_1417 = null;
var count__1414_1418 = (0);
var i__1415_1419 = (0);
while(true){
if((i__1415_1419 < count__1414_1418)){
var str_1420 = cljs.core._nth.call(null,chunk__1413_1417,i__1415_1419);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),str_1420);

var G__1421 = seq__1412_1416;
var G__1422 = chunk__1413_1417;
var G__1423 = count__1414_1418;
var G__1424 = (i__1415_1419 + (1));
seq__1412_1416 = G__1421;
chunk__1413_1417 = G__1422;
count__1414_1418 = G__1423;
i__1415_1419 = G__1424;
continue;
} else {
var temp__4425__auto___1425 = cljs.core.seq.call(null,seq__1412_1416);
if(temp__4425__auto___1425){
var seq__1412_1426__$1 = temp__4425__auto___1425;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1412_1426__$1)){
var c__1003__auto___1427 = cljs.core.chunk_first.call(null,seq__1412_1426__$1);
var G__1428 = cljs.core.chunk_rest.call(null,seq__1412_1426__$1);
var G__1429 = c__1003__auto___1427;
var G__1430 = cljs.core.count.call(null,c__1003__auto___1427);
var G__1431 = (0);
seq__1412_1416 = G__1428;
chunk__1413_1417 = G__1429;
count__1414_1418 = G__1430;
i__1415_1419 = G__1431;
continue;
} else {
var str_1432 = cljs.core.first.call(null,seq__1412_1426__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),str_1432);

var G__1433 = cljs.core.next.call(null,seq__1412_1426__$1);
var G__1434 = null;
var G__1435 = (0);
var G__1436 = (0);
seq__1412_1416 = G__1433;
chunk__1413_1417 = G__1434;
count__1414_1418 = G__1435;
i__1415_1419 = G__1436;
continue;
}
} else {
}
...
var args1439 = [];
var len__1258__auto___1442 = arguments.length;
var i__1259__auto___1443 = (0);
while(true){
if((i__1259__auto___1443 < len__1258__auto___1442)){
args1439.push((arguments[i__1259__auto___1443]));

var G__1444 = (i__1259__auto___1443 + (1));
i__1259__auto___1443 = G__1444;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args1439.length)].join('')));
...
return (function (){
if(cljs.core.truth_((function (){var and__207__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__1449 = script;
goog.object.set(G__1449,"type","text/javascript");

goog.object.set(G__1449,"onload",onload);

goog.object.set(G__1449,"onreadystatechange",onload);

return G__1449;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__1450 = script__$1;
goog.object.set(G__1450,"src",src);

return G__1450;
})():(function (){var G__1451 = script__$1;
goog.dom.setTextContext(G__1451,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__219__auto__ = reload;
...
var path_1452 = (goog.dependencies_.nameToPath[src]);
goog.object.remove(goog.dependencies_.visited,path_1452);

goog.object.remove(goog.dependencies_.written,path_1452);

goog.object.remove(goog.dependencies_.written,[cljs.core.str(goog.basePath),cljs.core.str(path_1452)].join(''));
} else {
}
